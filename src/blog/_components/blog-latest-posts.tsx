...
export default function BlogLatestPosts() {
  return (
    <>
      <div className="flex flex-col mt-[6.25em] gap-[2em] max-w-[1200px] lg:mx-auto  px-[1.25em]">
        <motion.p
        ...
        <motion.p
          className="text-[#828282] font-Inter text-[1.125rem font-normal text-center lg:w-[39.375em] self-center"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.5 }}
          variants={{
